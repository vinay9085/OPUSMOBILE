...
<body>
	...
	<div class="container">
		<div class="headerBarblock padding10">
        	Product Inventory
	  		<div class="floatRight closeX"></div>
            <div class="clear"></div>
      	</div>
        ...
        <div class="popupcontentBlock">
            <div>
                <div class="container1">
                    ...
                    <div class="boldText floatLeft selectWidth80 marginLeft20 blueText">Your Item has been successfully deleted</div>                           
                    <div class="clear"></div>
                </div>            
            </div>
            <div class="container1">
                <div class="floatRight">
                    <input type="submit" value=" Close " class="blueButton">
                </div>
                <div class="clear"></div>
            </div>            
        </div>    
